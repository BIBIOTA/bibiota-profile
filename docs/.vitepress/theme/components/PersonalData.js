export const personalDataRaw = {
  ...
  sideProjects: [
    ...
    },
    {
      name: 'job-scraper',
      description: {
        'zh-TW': '整合各大求職平台職缺的 CLI，可搭配 AI Agent 使用',
        en: 'CLI integrating job listings from major platforms, compatible with AI Agent workflows',
        ja: '主要求人プラットフォームの求人を統合するCLI、AI Agentと連携可能',
      },
