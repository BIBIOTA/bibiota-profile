...
- [ ] 1.1 Create shared blog style guide
...
- [ ] 1.2 Create shared article template
...
- [ ] 2.1 Create `blog-topic-planning` Skill
  ...
  - Depends on: 1.1
  - Independence: serial
- [ ] 2.2 Define topic planning handoff behavior
...
- [ ] 3.1 Create `blog-metadata-planning` Skill
  ...
  - Independence: serial
- [ ] 3.2 Define metadata confirmation gate
  ...
  - Depends on: 3.1
  - Independence: serial
- [ ] 3.3 Define slug and numbering safety checks
...
- [ ] 4.1 Create `blog-research-writing` Skill
  ...
  - Independence: serial
- [ ] 4.2 Define source quality requirements
  ...
  - Depends on: 4.1
  - Independence: serial
- [ ] 4.3 Define time-sensitive research behavior
  ...
  - Depends on: 4.1
  - Independence: serial
- [ ] 4.4 Define Daily Questions Challenge index update behavior
  ...
  - Depends on: 4.1, 4.2
  - Independence: serial
- [ ] 4.5 Define writing handoff behavior
...
- [ ] 5.1 Create `blog-article-review` Skill
  ...
  - Independence: serial
- [ ] 5.2 Define mechanical fix behavior
  ...
  - Depends on: 5.1
  - Independence: serial
- [ ] 5.3 Define judgment issue behavior
  ...
  - Depends on: 5.1
  - Independence: serial
- [ ] 5.4 Define final verification handoff
...
- [ ] 6.1 Standardize stage output locations
  ...
  - Independence: serial
- [ ] 6.2 Standardize terminal statuses
  ...
  - Independence: serial
- [ ] 6.3 Ensure Skills remain independently runnable
...
## 7. Verification
- [ ] 7.1 Verify Skill documents against the design
