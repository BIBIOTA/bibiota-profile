...
- [x] 1.1 Create `docs/.vitepress/theme/components/Pagination.vue`
...
- [x] 2.1 Add `page` data property and `mounted()` URL parsing
...
- [x] 2.2 Add `currentPage`, `paginatedArticles`, and `totalPages` computed properties
...
- [x] 2.3 Add `handlePageChange(page)` method
...
- [x] 2.4 Update template to wire `paginatedArticles` and `<Pagination>`
